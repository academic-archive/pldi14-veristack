...
Inductive possible_event: world -> event -> world -> Prop :=
  ...
  | possible_event_call: forall id w,
                           possible_event w (Event_call id) w
  | possible_event_return: forall id w,
                           possible_event w (Event_return id) w
.
...
Proof.
  ...
  inv H4; inv H6; inv H3; inv H7; auto.
  inv H4; inv H6; inv H3; inv H7; auto.
Qed.
