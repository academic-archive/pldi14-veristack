...
Record agree (ms: Mach.regset) (sp: val) (rs: Asm.regset) : Prop := mkagree {
  agree_sp: rs#SP = sp;
  agree_sp_def: exists b, exists o, sp = Vptr b o (* sp <> Vundef *); 
...
Lemma agree_exten_temps:
  ...
  agree (Mach.undef_temps ms) sp rs'.
Proof.
  intros. destruct H. split; auto.
  rewrite H0; auto. auto. 
  intros. unfold Mach.undef_temps. 
...
Lemma agree_set_undef_mreg:
  ...
  agree (Mach.Regmap.set r v (Mach.undef_temps ms)) sp rs'.
Proof.
...
Lemma agree_change_sp:
  forall ms sp rs sp',
  agree ms sp rs -> (* sp' <> Vundef *) (exists b o, sp' = Vptr b o) ->
...
Proof.
  ...
  exploit code_tail_unique. eexact H11. eapply H0; eauto. intro.
...
Inductive match_stack: list Mach2.stackframe -> Prop :=
  | match_stack_nil:
      match_stack nil
  | match_stack_cons: forall fb (* sp *) ra c s f tf tc,
      ...
      True (* sp <> Vundef *) ->
      match_stack s ->
      match_stack (Mach2.Stackframe fb ra c :: s).
