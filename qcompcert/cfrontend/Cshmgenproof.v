...
Lemma transl_function_id: forall f tf, transl_function f = OK tf ->  Clight.fn_id f = fn_id tf.
Proof.
  unfold transl_function, bind. intros. destruct (transl_statement (fn_return f) 1 0 (Clight.fn_body f)); try discriminate. inv H; simpl; reflexivity.
Qed.
