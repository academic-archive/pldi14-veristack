...
Lemma transl_function_id: forall f tf, transl_function f = OK tf ->  Csyntax.fn_id f = fn_id tf.
Proof.
  unfold transl_function. intros. destruct (transl_stmt (Csyntax.fn_body f) (initial_generator tt)); try discriminate. inv H; simpl; reflexivity.
Qed.
...
(* return some 2 *)
  ...
  eauto. eapply transl_function_id; eauto. traceEq.
  constructor. apply match_cont_call; auto.
(* skip return *)
  inv H8. 
